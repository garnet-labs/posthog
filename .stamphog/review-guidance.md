...
- A chain marked [NEW CHAIN] is new versus the previously profiled commit — the strongest divergence signal available; it requires the same diff-must-explain-it treatment.
