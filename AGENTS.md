...
- ClickHouse schema management: `python manage.py ch_migrate <plan|apply|drift|schema|generate|lint|orphans|version|status|bootstrap>`. See `posthog/clickhouse/migration_tools/README.md`.
