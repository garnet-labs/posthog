...
# -- Column and Table domain model --
# These are the building blocks every SQL source implementation file uses
# to express table metadata and convert columns to PyArrow fields.
...
# -- Type aliases for SQL source internals --

# Return type of _schema_fetcher: table_name -> list of (column_name, data_type, is_nullable)
SchemaColumns = dict[str, list[tuple[str, str, bool]]]

# Return type of _get_foreign_keys: table_name -> list of (column, target_table, target_column)
ForeignKeyMapping = dict[str, list[tuple[str, str, str]]]

# Return type of _get_row_counts: table_name -> row_count
RowCountMapping = dict[str, int]

# Handler signature for _get_extra_exception_handlers entries
ExceptionHandler = Callable[[Exception], tuple[bool, str | None]]

# Mapping of error message substrings to user-friendly messages
ConnectionErrorMap = dict[str, str]
