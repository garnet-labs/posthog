...
TEMPORAL_POD_TERMINATION_ENABLED: bool = get_from_env("TEMPORAL_POD_TERMINATION_ENABLED", False, type_cast=str_to_bool)
TEMPORAL_POD_TERMINATION_BASE_TIMEOUT_MINUTES: int = get_from_env(
    "TEMPORAL_POD_TERMINATION_BASE_TIMEOUT_MINUTES", 30, type_cast=int
)
TEMPORAL_POD_TERMINATION_JITTER_MINUTES: int = get_from_env(
    "TEMPORAL_POD_TERMINATION_JITTER_MINUTES", 45, type_cast=int
)
