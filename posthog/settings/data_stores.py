...
CLICKHOUSE_HOST: str = os.getenv("CLICKHOUSE_HOST", "clickhouse" if DEBUG else "localhost")
CLICKHOUSE_LOGS_HOST: str = os.getenv("CLICKHOUSE_LOGS_HOST", CLICKHOUSE_HOST)
