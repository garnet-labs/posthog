...
BOT_DEFINITIONS: dict[str, BotDefinition] = {
    # AI Agents
    "GPTBot": BotDefinition("GPTBot", "llm_crawler", "AI Agent", "OpenAI"),
    "OAI-SearchBot": BotDefinition("OpenAI Search", "llm_crawler", "AI Agent", "OpenAI"),
    "ChatGPT-User": BotDefinition("ChatGPT", "llm_crawler", "AI Agent", "OpenAI"),
    "ClaudeBot": BotDefinition("Claude", "llm_crawler", "AI Agent", "Anthropic"),
    "Claude-Web": BotDefinition("Claude Web", "llm_crawler", "AI Agent", "Anthropic"),
    "anthropic-ai": BotDefinition("Anthropic", "llm_crawler", "AI Agent", "Anthropic"),
    "PerplexityBot": BotDefinition("Perplexity", "llm_crawler", "AI Agent", "Perplexity"),
    "Google-Extended": BotDefinition("Google AI", "llm_crawler", "AI Agent", "Google"),
    "CCBot": BotDefinition("Common Crawl", "llm_crawler", "AI Agent", "Common Crawl"),
    "Applebot-Extended": BotDefinition("Apple AI", "llm_crawler", "AI Agent", "Apple"),
    "cohere-ai": BotDefinition("Cohere", "llm_crawler", "AI Agent", "Cohere"),
    "meta-externalagent": BotDefinition("Meta AI", "llm_crawler", "AI Agent", "Meta"),
    "Meta-ExternalFetcher": BotDefinition("Meta Fetcher", "llm_crawler", "AI Agent", "Meta"),
    "Bytespider": BotDefinition("ByteDance", "llm_crawler", "AI Agent", "ByteDance"),
    "Diffbot": BotDefinition("Diffbot", "llm_crawler", "AI Agent", "Diffbot"),
    "omgili": BotDefinition("Webz.io", "llm_crawler", "AI Agent", "Webz.io"),
    "Webzio-Extended": BotDefinition("Webz.io Extended", "llm_crawler", "AI Agent", "Webz.io"),
    "Timpibot": BotDefinition("Timpi", "llm_crawler", "AI Agent", "Timpi"),
    # Search Crawlers (Applebot must come after Applebot-Extended above)
    "Applebot": BotDefinition("Applebot", "search_crawler", "Bot", "Apple"),
    "Amazonbot": BotDefinition("Amazon", "search_crawler", "Bot", "Amazon"),
