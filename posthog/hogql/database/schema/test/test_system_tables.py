...
def _create_dashboard_tile(team: Team, label: str) -> DashboardTile:
    ...
    insight = Insight.objects.create(team=team, name=f"insight_for_tile_{label}")
    return DashboardTile.objects.create(dashboard=dashboard, insight=insight, team=team)
