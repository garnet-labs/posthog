...
POSTGRES_FUNCTION_HANDLERS: dict[str, Callable[[list[str]], str]] = {
    ...
    "toInt8": _make_cast_handler("SMALLINT"),
    "toInt16": _make_cast_handler("SMALLINT"),
    "toInt32": _make_cast_handler("INTEGER"),
    "toInt64": _make_cast_handler("BIGINT"),
    "toInt128": _make_cast_handler("BIGINT"),
    "toInt256": _make_cast_handler("BIGINT"),
    "toUInt8": _make_cast_handler("SMALLINT"),
    "toUInt16": _make_cast_handler("INTEGER"),
    "toUInt32": _make_cast_handler("BIGINT"),
    "toUInt64": _make_cast_handler("BIGINT"),
    "toUInt128": _make_cast_handler("BIGINT"),
    "toUInt256": _make_cast_handler("BIGINT"),
    "toFloat": _make_cast_handler("DOUBLE PRECISION"),
    "toFloat32": _make_cast_handler("REAL"),
    ...
    "toFloatOrNull": _make_cast_handler("DOUBLE PRECISION"),
    "toFloat32OrNull": _make_cast_handler("REAL"),
    "toFloat64OrNull": _make_cast_handler("DOUBLE PRECISION"),
    "toInt8OrNull": _make_cast_handler("SMALLINT"),
    "toInt16OrNull": _make_cast_handler("SMALLINT"),
    "toInt32OrNull": _make_cast_handler("INTEGER"),
