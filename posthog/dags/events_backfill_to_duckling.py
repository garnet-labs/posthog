...
def export_events_to_duckling_s3(
    ...
    path_without_scheme = (
        f"{BACKFILL_EVENTS_S3_PREFIX}/{team_id}/{year}/{month}/{day}/{run_id}.parquet"
    )
...
def export_persons_to_duckling_s3(
    ...
    path_without_scheme = (
        f"{BACKFILL_PERSONS_S3_PREFIX}/{team_id}/{year}/{month}/{day}/{run_id}.parquet"
    )
    s3_url = get_s3_url_for_clickhouse(
        catalog.bucket, catalog.bucket_region, path_without_scheme
    )
...
def export_persons_full_to_duckling_s3(
    ...
    """
    path_without_scheme = (
        f"{BACKFILL_PERSONS_S3_PREFIX}/{team_id}/full/{run_id}.parquet"
    )
    s3_url = get_s3_url_for_clickhouse(
        catalog.bucket, catalog.bucket_region, path_without_scheme
    )
