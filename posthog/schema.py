...
class ActionStepStringMatching(StrEnum):
    CONTAINS = "contains"
    EXACT = "exact"
    REGEX = "regex"
...
class ActionStepType(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    event: str | None = None
    href: str | None = None
    href_matching: ActionStepStringMatching | None = "ActionStepStringMatching.Exact"
    name: str | None = None
    properties: (
        list[
            EventPropertyFilter
    ...
    selector: str | None = None
    tag_name: str | None = Field(default=None, deprecated="Only `selector` should be used now.")
    text: str | None = None
    text_matching: ActionStepStringMatching | None = "StringMatching.Exact"
    url: str | None = None
    url_matching: ActionStepStringMatching | None = "StringMatching.Contains"
...
class SessionBatchEventsQuery(BaseModel):
    ...
    actionSteps: list[ActionStepType] | None = Field(
        default=None,
        description=("Show events matching the given action steps (for previewing unsaved actions)"),
    )
