"""Django/ClickHouse stubs so migration_tools tests run without infrastructure.

Import BEFORE any posthog imports:

    import posthog.clickhouse.test._stubs as _stubs  # noqa: F401

Stubs install on import, are idempotent, and safe to import multiple times.
"""
