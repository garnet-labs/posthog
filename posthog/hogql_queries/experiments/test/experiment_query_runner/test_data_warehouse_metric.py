...
class TestExperimentQueryRunner(ExperimentQueryRunnerBaseTest):
    ...
    def test_query_runner_with_data_warehouse_internal_filters(self, name, filter: dict, filter_expected: dict):
        ...
        _create_person(
            team=self.team,
            distinct_ids=["user_test_4"],
        )
        _create_person(
            team=self.team,
            distinct_ids=["user_test_5"],
        )
    ...
    def test_query_runner_with_data_warehouse_subscriptions_table(self):
        ...
        metric = ExperimentMeanMetric(
            source=ExperimentDataWarehouseNode(
                ...
                distinct_id_field="subscription_customer.customer_email",
        ...
        # Populate exposure events using email as distinct_id to match DW subscription_customer.customer_email
        control_emails = ["john.doe@example.com"]
        test_emails = ["jane.doe@example.com", "john.smith@example.com", "jane.smith@example.com"]
        ...
        self.assertEqual(control_result.number_of_samples, 1)
        self.assertEqual(test_result.number_of_samples, 3)
