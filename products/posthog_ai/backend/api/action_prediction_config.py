...
class ActionPredictionConfigSerializer(serializers.ModelSerializer):
...
class ActionPredictionConfigViewSet(TeamAndOrgViewSetMixin, viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        task = Task.create_and_run(
            ...
            description=f"/training-action-predictions Train the model for this configuration {serializer.validated_data}",
