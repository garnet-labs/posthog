"""
train.py — Run 007: Predict "went inactive" on PostHog prod (project 2).

Target: P(active UI user has zero pageview/autocapture in next 14 days)
Population: identified users with ≥100 UI events in observation window
Data source: us.posthog.com project 2

Usage:
    cd products/posthog_ai/skills/training-action-predictions/runs/007-went-inactive
