"""
train.py — Run 002: Predict "Looked at an LLM trace" on PostHog prod (project 2).

Target: P(user views an LLM trace detail page within 14 days)
Data source: us.posthog.com project 2

Usage:
    cd products/posthog_ai/skills/training-action-predictions/runs/002-looked-at-llm-trace
