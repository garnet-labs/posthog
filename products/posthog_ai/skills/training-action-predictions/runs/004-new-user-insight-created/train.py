"""
train.py — Run 004: Predict "insight created" for NEW users on PostHog prod (project 2).

Target: P(new user creates an insight in their first 14 days)
Population: users who signed up ≤14 days before the label window
Data source: us.posthog.com project 2

Usage:
    cd products/posthog_ai/skills/training-action-predictions/runs/004-new-user-insight-created
    flox activate -- bash -c "uv pip install xgboost -q && python train.py"
"""
