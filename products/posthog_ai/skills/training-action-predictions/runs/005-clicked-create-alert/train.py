"""
train.py — Run 005: Predict "Clicked Create Alert" on PostHog prod (project 2).

Target: P(analytics user clicks "Create alert" within 30 days)
Population: identified users with ≥50 events who use insights/dashboards
Data source: us.posthog.com project 2

Usage:
    cd products/posthog_ai/skills/training-action-predictions/runs/005-clicked-create-alert
