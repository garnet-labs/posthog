...
export function HogbotResearch(): JSX.Element {
    ...
    const { loadFiles, selectFile } = useActions(hogbotResearchLogic)
        ...
        <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between">
                <div className="text-sm text-muted">
                    Research files from <span className="font-mono">/research</span>
                </div>
                <LemonButton size="small" onClick={() => loadFiles()} loading={filesLoading}>
                    Refresh
                </LemonButton>
            </div>
