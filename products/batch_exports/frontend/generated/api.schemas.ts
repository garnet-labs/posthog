...
export interface BatchExportDestinationApi {
    /** Destination type: 'S3', 'Snowflake', 'Postgres', 'Redshift', 'BigQuery', 'Databricks', 'AzureBlob', or 'HTTP'.
...
* `NoOp` - Noop */
    ...
    /** Connection parameters for the destination. Required fields vary by destination type. Secret values are redacted in responses. */
    config: unknown
    /**
    ...
    /**
     * Optional ID of a PostHog integration to use for authentication instead of manual credentials.
     * @nullable
     */
...
* `Running` - Running
* `Starting` - Starting */
    readonly status: BatchExportRunStatusEnumApi
    /**
     * The number of records that have been exported.
     * @nullable
     */
    readonly records_completed: number | null
    /**
    ...
    readonly data_interval_end: string
    /**
     ...
     * @nullable
     */
    readonly records_total_count: number | null
    /**
     * The backfill this run belongs to.
     * @nullable
     */
    readonly backfill: string | null
    /**
     * The number of bytes that have been exported in this BatchExportRun.
     * @nullable
     */
    readonly bytes_exported: number | null
}
...
export interface BatchExportApi {
    /** Unique identifier for this batch export. */
    readonly id: string
    /** The project this batch export belongs to. */
    readonly team_id: number
    /** Human-readable name for this batch export. */
    name: string
    /**
     * Data model to export: 'events', 'persons', or 'sessions'. Defaults to 'events'.
     * @nullable
     */
    model?: string | null
    /** Destination configuration including type and connection parameters. */
    destination: BatchExportDestinationApi
    /** Export frequency: 'hour', 'day', 'week', 'every 5 minutes', or 'every 15 minutes'.
...
* `every 15 minutes` - every 15 minutes */
    ...
    /** Whether the export is currently paused. Use the pause/unpause endpoints to change this. */
    paused?: boolean
    /** When this batch export was created. */
    readonly created_at: string
    /** When this batch export was last modified. */
    readonly last_updated_at: string
    /**
     * When this batch export was last paused.
     * @nullable
     */
    last_paused_at?: string | null
    /**
     * Earliest datetime for runs. Runs will not be scheduled before this time.
     * @nullable
     */
    start_at?: string | null
    /**
     * Latest datetime for runs. The export stops scheduling after this time.
     * @nullable
     */
    end_at?: string | null
    /** The 10 most recent export runs with their status and record counts. */
    readonly latest_runs: readonly BatchExportRunApi[]
    /** HogQL SELECT query defining custom export fields. Advanced usage only. */
    hogql_query?: string
    /** Computed export schema derived from the HogQL query, if set. */
    readonly schema: unknown | null
    /** Optional event or person property filters to narrow the exported data. */
    filters?: unknown | null
    /** IANA timezone for scheduling (e.g. 'America/New_York'). Defaults to 'UTC'.
...
* `Zulu` - Zulu */
    ...
    /**
     * Day offset for weekly exports (0=Sunday through 6=Saturday). Only applicable for weekly interval.
     * @minimum 0
     * @maximum 6
     * @nullable
     */
    ...
    /**
     * Hour offset for daily and weekly exports (0-23). Only applicable for daily or weekly intervals.
     * @minimum 0
     * @maximum 23
     * @nullable
     */
...
export interface BatchExportUnpauseApi {
    /** Whether to backfill missed intervals since the export was paused. */
    backfill?: boolean
}
...
/**
 * Progress information with total_runs, finished_runs, and progress percentage. Only available for running backfills.
 * @nullable
 */
...
* `Running` - Running
* `Starting` - Starting */
    readonly status: BatchExportBackfillStatusEnumApi
     ...
     * @nullable
     */
    readonly total_records_count: number | null
    /**
     ...
     * @nullable
     */
    readonly adjusted_start_at: string | null
    /**
     * Progress information with total_runs, finished_runs, and progress percentage. Only available for running backfills.
     * @nullable
     */
...
export interface BatchExportBackfillCreateApi {
    /**
     * The start of the backfill range. Use ISO datetime (e.g. '2025-01-01T00:00:00Z') for hourly exports, or ISO date (e.g. '2025-01-01') for daily/weekly exports.
     * @nullable
     */
    start_at?: string | null
    /**
     * The end of the backfill range. Use ISO datetime (e.g. '2025-03-31T00:00:00Z') for hourly exports, or ISO date (e.g. '2025-03-31') for daily/weekly exports.
     * @nullable
     */
    end_at?: string | null
}
