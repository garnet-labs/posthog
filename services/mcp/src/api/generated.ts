...
export namespace Schemas {
    ...
    * `12` - 12
     ...
     * @nullable
     */
    export type HogQLASTQueryValues = { [key: string]: unknown } | null | null;

    /**
     * Variables to be substituted into the query
     * @nullable
     */
    export type HogQLASTQueryVariables = {[key: string]: HogQLVariable} | null | null;
    ...
    * `jira` - Jira
     */
    export type KindCf2Enum = typeof KindCf2Enum[keyof typeof KindCf2Enum];


    export const KindCf2Enum = {
      Slack: 'slack',
      Salesforce: 'salesforce',
      Hubspot: 'hubspot',
      GooglePubsub: 'google-pubsub',
