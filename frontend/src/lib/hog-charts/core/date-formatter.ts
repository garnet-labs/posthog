...
export type DateInterval = 'second' | 'minute' | 'hour' | 'day' | 'week' | 'month'
...
function pickMode(interval: DateInterval, parsedDates: Dayjs[], first: Dayjs, last: Dayjs): TickMode {
...
export function inferInterval(parsedDates: Dayjs[]): DateInterval {
