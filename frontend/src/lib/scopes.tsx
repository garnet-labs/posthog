...
export const API_SCOPES: APIScope[] = [
    ...
    { key: 'action_prediction', objectName: 'Action prediction', objectPlural: 'action predictions' },
    { key: 'action_prediction_model', objectName: 'Action prediction model', objectPlural: 'action prediction models' },
