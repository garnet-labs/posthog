...
import { SourceTypeEnum } from 'products/notifications/frontend/generated/api.schemas'
...
const SOURCE_TYPE_TO_PATH: Record<SourceTypeEnum, (id: string) => string> = {
...
export function buildNotificationSourcePath(notification: InAppNotification): string | null {
    if (notification.source_type && notification.source_id && notification.source_type in SOURCE_TYPE_TO_PATH) {
        return SOURCE_TYPE_TO_PATH[notification.source_type as SourceTypeEnum](notification.source_id)
    }
    ...
    listeners(({ actions, values, cache }) => ({
        ...
        startSSE: () => {
            ...
            void retryWithBackoff(
                () =>
                    connectToNotificationsSSE(url, token, abortController.signal, (notification) => {
